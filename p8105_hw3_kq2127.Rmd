...
instacart %>% 
  ...
  arrange(desc(n_obs))
```
Data set instacart has 1384617 observations and 15 variables.There are 134 aisles, and aisle number 83 (fresh vegetables) has the most items ordered from (150609).
